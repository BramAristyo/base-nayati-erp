...
class ProformaController extends Controller
{
    ...
    public function paginate(BasicPaginateRequest $request): Response
    {
        try {
            ...
            return Inertia::render('Sales/Proforma/Index', [
                ...
                'error' => 'Failed to load proformas.'
            ]);
        }
    }
    ...
    public function show(int $id): Response
    {
        try {
            ...
            return Inertia::render('Sales/Proforma/Show', [
                'proforma' => $data
            ]);
        } catch (Exception $e) {
            Log::error('Sales Proforma Show Error: ' . $e->getMessage(), [
                'id' => $id,
                'trace' => $e->getTraceAsString()
            ]);
