    ...
    protected function baseQuery(): Builder
    {
        return DB::table('hpo')
            ...
            ->select([
                ...
                'hpo.DISC1 as disc1_percentage',
                'hpo.DISCRP1 as disc1_amount_rupiah',
                'hpo.DISC2 as disc2_percentage',
                'hpo.DISCRP2 as disc2_amount_rupiah',
                'hpo.DISC3 as disc3_percentage',
                'hpo.DISCRP3 as disc3_amount_rupiah',
                'hpo.TPPN as tax_ppn_amount',
                'hpo.TPPNRP as tax_ppn_amount_rupiah',
