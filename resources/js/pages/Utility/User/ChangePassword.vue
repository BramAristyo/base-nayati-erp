...
<template>
    <div
        class="min-h-screen flex items-center justify-center font-sans selection:bg-gray-200 selection:text-black bg-[url('/images/bg.png')]">
            ...
            <form @submit.prevent="submit" class="flex flex-col gap-5">
                <div class="flex flex-col gap-1.5">
                    <label for="password" class="text-[10px] font-bold text-gray-400 uppercase tracking-wider">New
                        Password</label>
                    <Password id="password" v-model="form.password" placeholder="••••••••" toggleMask :feedback="false"
                        :invalid="!!form.errors.password" class="w-full" inputClass="w-full!" />
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <Password id="password_confirmation" v-model="form.password_confirmation" placeholder="••••••••"
                        toggleMask :feedback="false" :invalid="!!form.errors.password_confirmation" class="w-full"
                        inputClass="w-full!" />
                ...
                <Button type="submit" label="Save Changes"
                    class="w-full! py-2.5! mt-2! rounded-md! text-xs! bg-black! border-none! text-white! font-bold! uppercase! tracking-widest! transition-all! active:scale-95!"
