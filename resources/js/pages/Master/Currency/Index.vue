        ...
        <div class="flex flex-col gap-6">
            <div class="flex flex-col gap-4 md:flex-row md:items-center justify-between px-1">
                <div class="flex flex-col">
                    <h1 class="text-xl font-bold uppercase tracking-tight text-foreground">Master Currency</h1>
                    <p class="text-xs font-medium italic text-muted-foreground">Manage system currencies and exchange rates.</p>
                </div>
