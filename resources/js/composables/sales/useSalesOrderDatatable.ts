...
export function useSalesOrderDatatable(props: { data: PaginatedResponse<any>; filters: any }) {
    ...
    const onExport = () => {
        ...
        // Assuming a similar export route exists for sales orders
        window.location.assign(route('sales.orders.export', params));
    };
